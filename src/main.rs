...
fn add_elements(
    ...
    for year in years {
        for ch in specials {
            password_pool.push(format!("{}{}{}", variation, year, ch)); 
            password_pool.push(format!("{}{}{}", year, ch, variation)); 
            password_pool.push(format!("{}{}{}", variation, ch, year)); 
            password_pool.push(format!("{}{}{}", year, variation, ch)); 
        }
    }
}
...
fn generate_passwords(keywords: Vec<String>, filename: &str, year_from: u16, year_to: u16) {
    ...
    let iter_count = 2; // To ensure passwords are generated with and without human alternativ chars
    let mut iter_control = false;
    ...
    for _ in 0..iter_count {
        ...
        for mut keyword in keywords.clone() {
            if iter_control {
            ...
            for current in 0..variations_count {
                ...
                add_elements(&years, &specials, &mut generated_passwords, &mut variation);
            }
            ...
            for password in &generated_passwords {
                ...
                print!(
                    ...
                    password_count, password, " ".repeat(20)
                );
                stdout().flush().unwrap();
            }
        }
    ...
    print!("\r");
    println!("\rDone, generated {} passwords in total!{}", password_count, " ".repeat(10));
